...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/11/26 20:40:43 by cmutti            #+#    #+#             */
/*   Updated: 2015/12/16 13:08:13 by cmutti           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#endif
	lst = NULL;
	ft_lstadd(&lst, ft_lstnew((void const*)"test2", sizeof(char) * 6));
	ft_lstadd(&lst, ft_lstnew((void const*)"test1", sizeof(char) * 6));
	if (!cmp("test1", (char*)lst->content))
		test[0] = 0;
...
static void	test_strsplit(void)
{
	...
	init(ctrl, 11, 0);
	init(test, 11, 1);
	ctrl_tab = (char **)malloc(sizeof(*ctrl_tab) * 10);
#ifdef SEGFAULT_ME
